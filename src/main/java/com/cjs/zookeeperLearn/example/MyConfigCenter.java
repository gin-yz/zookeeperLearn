/*
* 将配置信息放入ｚｏｏｋｅｅｐｅｒ中，设置ｗａｔｃｈ，当ｚｏｏｋｅｅｐｅｒ中值改变时，可以随时同步本地信息
*
* */
...
public class MyConfigCenter implements Watcher {
    ...
    //值改变后ｇｅｔ值
    private void getValue() throws KeeperException, InterruptedException {
        Stat stat = new Stat();
        this.url = new String(zooKeeper.getData("/config/url", true, stat));
        this.username = new String(zooKeeper.getData("/config/username", true, null));
        this.password = new String(zooKeeper.getData("/config/password", true, null));
