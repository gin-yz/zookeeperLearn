package com.cjs.zookeeperLearn.baseUse;
...
public class ZKCreate {
    ...
    public void create1()throws Exception{
        ...
        // arg4:节点类型  持久化节点
        zooKeeper.create("/create/node1","node1".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT_SEQUENTIAL);
    }
    ...
    public void create5() throws Exception {
        // auth授权模式
        // 添加授权用户
        zooKeeper.addAuthInfo("digest", "hadoop1:123456".getBytes());
